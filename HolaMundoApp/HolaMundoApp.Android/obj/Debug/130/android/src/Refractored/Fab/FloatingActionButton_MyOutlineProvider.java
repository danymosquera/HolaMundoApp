...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Refractored.Fab.FloatingActionButton+MyOutlineProvider, Refractored.Fab", FloatingActionButton_MyOutlineProvider.class, __md_methods);
	}
	...
	public FloatingActionButton_MyOutlineProvider ()
	{
		...
		if (getClass () == FloatingActionButton_MyOutlineProvider.class) {
			mono.android.TypeManager.Activate ("Refractored.Fab.FloatingActionButton+MyOutlineProvider, Refractored.Fab", "", this, new java.lang.Object[] {  });
		}
	}
	...
	public FloatingActionButton_MyOutlineProvider (android.content.res.Resources p0, int p1)
	{
		super ();
		if (getClass () == FloatingActionButton_MyOutlineProvider.class) {
			mono.android.TypeManager.Activate ("Refractored.Fab.FloatingActionButton+MyOutlineProvider, Refractored.Fab", "Android.Content.Res.Resources, Mono.Android:Refractored.Fab.FabSize, Refractored.Fab", this, new java.lang.Object[] { p0, p1 });
		}
	}
